        ...
        if(isset($_POST['submit'])) {
            if(isset($_POST['fullname']) || 
                ...
                if(preg_match($reg_patt, $MBR_PASS)){
                    ...
                    $ck = substr_count($MBR_NAME,'\\');
                    if($ck = 1){
                        $MBR_NAME2 = str_replace('\\','\''.'\''.'\'',$MBR_NAME);
                    };
                    /*
                ...
                }else { die ("<script>location.href = '".$_SERVER['REQUEST_URI']."?notif=".base64_encode('Pola Password Tidak Sesuai')."'</script>"); }
