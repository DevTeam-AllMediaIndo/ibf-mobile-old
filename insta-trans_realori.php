        ...
        <script>
            ...
            function change_bank(){
                if(document.getElementById('bank_option').value == 'Bank 1'){
                    ...
                    document.getElementById('ACC_F_APP_BK_ACC').value   = ress[0].bk_acc_1;
                    ...
                    document.getElementById('ACC_F_APP_BK_ACC').value   = ress[0].bk_acc_2;
                                ...
                                <div class="card card-style">
                                    <div class="content">
                                        ...
                                        <div class="input-wrapper mt-2">
                                            ...
                                            <input type="text" class="form-control" id="" value="${resp[0].pers_name}" name="pers_name" readonly required>
                                        </div>
                                        <div class="row" style="margin-bottom: unset;">
                                            <div class="col-6">
                                                <div class="input-wrapper mt-2">
                                                    <label class="label" for="text4b">Cabang Bank</label>
                                                    <input type="text" class="form-control" id="ACC_F_APP_BK_CBNG" value="${resp[0].bk_brnch_1}" readonly required>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="input-wrapper mt-2">
                                                    <label class="label" for="text4b">Bank Rekening</label>
                                                    <input type="text" class="form-control" id="ACC_F_APP_BK_ACC" value="${resp[0].bk_acc_1}" readonly required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-bottom: unset;">
                                            <div class="col-6">
                                                <div class="input-wrapper mt-2">
                                                    ...
                                                    <input type="text" class="form-control" id="ACC_F_APP_BK_TLP" value="${resp[0].bk_tlp_1}" readonly required>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="input-wrapper mt-2">
                                                    <label class="label" for="text4b">Jenis Tabungan</label>
                                                    <input type="text" class="form-control" id="ACC_F_APP_BK_JENIS" value="${resp[0].bk_type_1}" readonly required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
