                ...
                <div id="accordion001" class="accordion-collapse collapse" data-bs-parent="#accordionExample2">
                    <div class="accordion-body">
                        <ul>
                            ...
                            ?>
                                <li><a href="home.php?page=order&id=<?php echo $RESULT_QUERY['ACC_LOGIN_HASH'] ?>"><?php if($RESULT_QUERY['ACC_LOGIN'] == 0){ echo 'waiting account submited'; } else { echo $RESULT_QUERY['ACC_LOGIN']; } ?></a></li>
                            <?php };} else { ?>
                                <li>No Account</li>
                            <?php }; ?>
                        </ul>
                        ...
                        <div class="content">
                            ...
                            <div class="d-flex">
                                <div class="align-self-center me-2">
                                    <h4 class="color-white rounded-sm shadow-l font-12 font-400 p-1 px-2 mt-0 mb-3">
                                        <?php
                                            if($HIST_RES["DPWD_TYPE"] == 'Deposit'){
                                        ?>
                                ...
                                <div class="align-self-center ms-auto">
                                    ...
                                    <span class="slider-next badge bg-<?php if($HIST_RES["DPWD_STS"] == 'Pending'){ echo 'yellow';}elseif($HIST_RES["DPWD_STS"] == 'Accept'){ echo 'green';}else{echo 'red';}?>-dark mt-2 p-2 font-8"><?php echo $HIST_RES["DPWD_STS"]?>
                                    </span>
                                </div>
                            </div>   
                        </div>
