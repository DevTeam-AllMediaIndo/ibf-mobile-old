<div class="card-body mb-n4">
    <div class="alert me-3 ms-3 rounded-s bg-green-dark" role="alert">
        ...
        <strong class="alert-icon-text"><?php echo "jkfjaslkdfj"; ?>.</strong>
    ...
    <div class="splide single-slider slider-no-arrows slider-no-dots homepage-slider" id="single-slider-1">
        <div class="splide__track">
            ...
            <div class="splide__slide">
                    <div class="card rounded-l mx-2 text-center shadow-l" data-card-height="320" style="background-image: url('<?php echo convertToBase64('assets/img/new-slide.jpeg'); ?>');">
                        <div class="card-bottom">
                            <p class="boxed-text-xl">
                                Ikuti kuis berhadiah di instagram <b><a href="https://instagram.com/ibf.trader?igshid=Yzg5MTU1MDY=">@ibf.trader</a> dengan total hadiah Jutaan Rupiah!</b>
                            </p>
                        </div>
                ...
                <div class="splide__slide">
                    <div class="card rounded-l mx-2 text-center shadow-l" data-card-height="320" style="background-image: url('<?php echo convertToBase64('assets/img/slide5.jpg'); ?>');"> 
                        <div class="card-bottom">
                            <p class="boxed-text-xl">
                ...
                <div class="splide__slide">
                    <div class="card rounded-l mx-2 text-center shadow-l" data-card-height="320" style="background-image: url('<?php echo convertToBase64('assets/img/imlek4.jpg'); ?>');">
                        <div class="card-bottom">
                            <p class="boxed-text-xl">
                                Selamat hari raya imlek 2023 <br> Gong Xi Fa Cai
                            </p>
                        </div>
                        <div class="card-overlay bg-gradient-fade"></div>
                    </div>
        ...
        <div class="content">            
            <div class="d-flex mb-4 pb-3">
                <div class="text-center">
                    ...
                    <h5 class="font-16 font-600">IBF Trader 4</h5>
