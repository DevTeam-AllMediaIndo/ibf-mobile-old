...
<?php
    ...
    if(mysqli_num_rows($SQL_QUERY) > 0){
        ...
        $AMOUNT_USD = $RESULT_QUERY['DPWD_AMOUNT']/$RESULT_QUERY['ACC_RATE'];
    };
                    ...
                    <tr>
                        <td width="55%">
                            ...
                            <table border="0" style="border-collapse: collapse;" width="100%">
                                ...
                                <tr>
                                    <td style="border-left: 1px solid black;text-align:right;">'.number_format($AMOUNT_IDR/$AMOUNT_RATE, 2).'&nbsp;&nbsp;</td>
