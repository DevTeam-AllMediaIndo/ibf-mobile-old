...
<?php
            ...
            <body>
                ...
                <table style="margin-top:25px;" width="100%">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td width="1%">&nbsp;</td>
                        <td style="border-bottom: 1px solid;text-align:left">( '.$curr_ag.' '.number_format($AMOUNT_IDR, 0).' )</td>
                    </tr>
                </table>
                        ...
                        <td width="55%">
                            ...
                            <table border="0" style="border-collapse: collapse;" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid black;text-align:right;">'.$curr_lg.' '.number_format($AMOUNT_IDR, 0).'&nbsp;&nbsp;</td>
                                </tr>
                            </table>
                        </td>
                        <td width="5%">&nbsp;</td>
    ...
    $dompdf->render();
    $dompdf->stream("Withdrawal Form IBF",array("Attachment"=>0));   