                        ...
                        <ol>
                            ...
                            <li seq=" (4)">Kantor atau kantor cabang Pialang Berjangka terdekat dengan domisili Nasabah tempat penyelesaian dalam hal terjadi perselisihan.
                                <table width="50%" style="margin-left:5px;">
                                    ...
                                    <tr>
                                        <td>a.'.$ACC_F_PERJ_KANTOR.'</td>
                                        <td><input type="radio" name="step07_kantorpenyelesaian" checked="checked" value="BANDUNG" required ></td>
                                    </tr>
                                    <tr>
                                        <td>b.PURWOKERTO</td>
                                        <td><input type="radio" name="step07_kantorpenyelesaian" value="PURWOKERTO" required ></td>
                                    </tr>
                                </table>
                            </li>
                        </ol>
