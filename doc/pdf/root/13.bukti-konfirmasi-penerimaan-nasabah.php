        ...
        <html>
            ...
            <body>
                ...
                <table style="border-spacing: 2px;">
                    ...
                    <tr>
                        <td style="vertical-align: top;">'.$ACC_S6_IDTYPE.'</td>
                        <td width="1%" style="vertical-align: top; text-align:center;">&nbsp;:&nbsp;</td>
                        <td>'.$ACC_S6_IDNO.'</td>
                    </tr>
                    <tr>
                ...
                <p>
                    Bahwa '.$bapakatauibu.' '.$MBR_NAME.' telah resmi menjadi Nasabah PT. INTERNATIONAL BUSINESS FUTURES sejak tanggal '.date('d', strtotime($ACC_F_DISC_DATE)).' '.$date_month.' '.date('Y', strtotime($ACC_F_DISC_DATE)).' dengan nomor account new account berdasarkan Perjanjian Pemberian Amanat yang '.$bapakatauibu.' '.$MBR_NAME.' telah isi dan
