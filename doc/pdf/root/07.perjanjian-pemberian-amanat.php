...
<?php
    ...
    $SQL_QUERY = mysqli_query($db, '
        SELECT
            ...
            IF(DATE(ACC_F_PERJ_DATE) < DATE("2023-02-03"), ACC_F_PERJ_PERSLISIHAN, ACC_F_PERJ_KANTOR) AS  ACC_F_PERJ_KANTOR,
            IF(DATE(ACC_F_PERJ_DATE) < DATE("2023-02-03"), ACC_F_PERJ_KANTOR, ACC_F_PERJ_PERSLISIHAN) AS ACC_F_PERJ_PERSLISIHAN,
    ...
    if(mysqli_num_rows($SQL_QUERY) > 0){
        ...
        if($ACC_F_PERJ_KANTOR == 'Pengadilan Negeri Bandung' || preg_match("/BANDUNG/i", $ACC_F_PERJ_KANTOR)){
            $CHECK1 = '';
        ...
        if($ACC_F_PERJ_PERSLISIHAN == 'BANDUNG'|| preg_match("/BANDUNG/i", $ACC_F_PERJ_PERSLISIHAN)){
    ...
    $content = '
        ...
        <html>
            ...
            <body>
                ...
                transaksi penjualan maupun pembelian Kontrak '.ucwords($title).' 
                        ...
                        <ol>
                            ...
                            <li seq=" (3)">
                                ...
                                <ol>
                                    ...
                                    <li seq=" b.">
                                        <input type="radio" name="step07_kotapenyelesaian" '.$CHECK2.' value="Pengadilan Negeri Bandung" required /> Pengadilan Negeri Bandung
                                    </li>
                                </ol>
                            </li>
                            <li seq=" (4)">Kantor atau kantor cabang Pialang Berjangka terdekat dengan domisili Nasabah tempat penyelesaian dalam hal terjadi perselisihan.
                                <table width="50%" style="margin-left:5px;">
                                    ...
                                    <tr>
                                        <td>a.BANDUNG</td>
                                        <td><input type="radio" name="step07_kantorpenyelesaian" '.$cek1.' value="BANDUNG" required ></td>
                                    </tr>
                                    <tr>
                                        <td>b.PURWOKERTO</td>
                                        <td><input type="radio" name="step07_kantorpenyelesaian" '.$cek2.' value="PURWOKERTO" required ></td>
                                    </tr>
                                </table>
                            </li>
                        </ol>
