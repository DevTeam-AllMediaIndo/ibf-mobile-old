            ...
            <body>
                ...
                <div style="border:1px solid black;padding:5px;margin-top:45px;">
                    <div style="text-align:left;vertical-align: middle;padding: 10px 0 10px 0;">
                        ...
                        <table width="100%" style="margin:0 20px;">
                            <tr>
                                <td width="40%">No. 120/AK-KBI/X/2024</td>
                                <td width="10%">&nbsp;</td>
                    ...
                    <div style="text-align:left;vertical-align: middle;padding: 10px 0 10px 0;">
                        ...
                        <table style="margin-left:20px;width:100%">
                            <tr>
                                ...
                                <td>Febiyanti</td>
                                <td>31.</td>
                                <td>Pratika Devianti</td>
                            </tr>
                            <tr>
                                <td>2.</td>
                                <td>Agus Slamet Medya</td>
                                <td>17.</td>
                                <td>Tega Apria Abdi</td>
                                <td>32.</td>
                                <td>Nia Chusniatin</td>
                            </tr>
                            <tr>
                                <td>3.</td>
                            ...
                            <tr>
                                ...
                                <td>Faisal Rahman</td>
                                <td>37.</td>
                                <td>Ricky Yefi Nurrahman</td>
                            </tr>
                            <tr>
                                <td>8.</td>
                                <td>Novi Asnuriani</td>
                                <td>23.</td>
                                <td>Margareth Tuasuun</td>d>
                                <td>38.</td>
                                <td>Syahrul Hanafia</td>
                            </tr>
                            <tr>
                                <td>9.</td>
