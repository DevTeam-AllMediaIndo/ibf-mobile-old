<?php
    ...
    if($RESULT_QUERY['ACC_RATE'] == 0 && $RESULT_QUERY['ACC_CURR'] == 'IDR'){ 
        $curr_idr = number_format($RESULT_QUERY['ACCCND_AMOUNTMARGIN'], 0);
        $curr = number_format($RESULT_QUERY['ACCCND_AMOUNTMARGIN'], 0);
        $curr_lg = 'IDR';
        $curr_ag = 'Rp';
        ...
        $curr_idr = 0;
        $curr = number_format($RESULT_QUERY['ACCCND_AMOUNTMARGIN'], 2);
        $curr_lg = 'USD';
        $curr_ag = '$';
    }else{
        $curr_idr = 0;
