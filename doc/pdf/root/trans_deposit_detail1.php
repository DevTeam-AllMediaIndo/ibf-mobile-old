...
<?php
    ...
    if(mysqli_num_rows($SQL_QUERY) > 0){
        ...
        $ACC_LOGIN = $RESULT_QUERY['ACCCND_LOGIN'];
        $MBR_NAME = $RESULT_QUERY['ACC_F_APP_PRIBADI_NAMA'];
    ...
    if($RESULT_QUERY['ACC_RATE'] == 0 && $RESULT_QUERY['ACC_CURR'] == 'IDR'){ 
        $curr_idr = number_format($AMOUNT_IDR, 0);
        //----------------------------
        $curr = number_format($AMOUNT_IDR, 0);
        //----------------------------
        $curr_lg = 'IDR';
        $curr_ag = 'Rp';
    }else if($RESULT_QUERY['ACC_RATE'] <> 0 && $RESULT_QUERY['ACC_CURR'] == 'IDR'){ 
        $curr_idr = number_format($AMOUNT_IDR, 0);
        $curr = number_format($AMOUNT_IDR/$rate, 0);
        $curr_lg = 'IDR';
        $curr_ag = 'Rp';
    }else if($RESULT_QUERY['ACC_RATE'] == 0 && $RESULT_QUERY['ACC_CURR'] == 'USD'){
        $curr_idr = number_format($AMOUNT_IDR, 2);
        $curr = number_format($AMOUNT_IDR, 2);
        $curr_lg = 'USD';
        $curr_ag = '$';
    }else{
        $curr_idr = 0;
        $curr = number_format($AMOUNT_IDR/$rate, 2);
        $curr_lg = 'USD';
        $curr_ag = '$';
    }
    ...
    $content = '
        ...
        <html>
            ...
            <body>
                <table width="100%">
                    <tr>
                        <td width="25%" style="vertical-align: top; "><img src="data:image/png;base64,'.base64_encode(file_get_contents("https://allmediaindo-2.s3.ap-southeast-1.amazonaws.com/ibftrader/logoibf.png")).'" width="100%"></td>
                ...
                <center><strong><u>MARGIN RECEIPT</u></strong></center>
                <table style="margin-top:25px;" width="100%">
                    ...
                    <tr>
                        ...
                        <td width="1%">&nbsp;:&nbsp;</td>
                        <td>'.terbilang($curr_idr).'</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td width="1%">&nbsp;</td>
                        <td style="border-bottom: 1px solid;text-align:left">( '.$curr_ag.' '.$curr_idr.' )</td>
                    </tr>
                </table>
                <table border="0" style="border-collapse: collapse;margin-top:5px;" width="100%">
                    <tr>
                        <td width="55%">
                            ...
                            <table border="0" style="border-collapse: collapse;" width="100%">
                                <tr>
                                    ...
                                    <td style="border: 1px solid black;text-align:center;">Amount in '.$curr_lg.'.</td>
                                </tr>
                                <tr>
                                    <td style="border-left: 1px solid black;text-align:right;">'.$curr.'&nbsp;&nbsp;</td>
                                    <td style="border-left: 1px solid black;text-align:right;">'.number_format($AMOUNT_RATE, 0).'&nbsp;&nbsp;</td>
                                    <td style="border-left: 1px solid black;text-align:right;border-right: 1px solid black;">'.$curr_idr.'&nbsp;&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td>Total</td>
                                    <td style="border: 1px solid black;text-align:right;">'.$curr_lg.' '.$curr_idr.'&nbsp;&nbsp;</td>
                                </tr>
                            </table>
                        </td>
                        <td width="5%">&nbsp;</td>
                        <td width="40%">
                            ...
                            PT. INTERNATIONAL BUSSINESS FUTURES</p>
                            <br><br><br>
    ...
    $dompdf->render();
    $dompdf->stream("Deposit Margin Receipt IBF",array("Attachment"=>0));   