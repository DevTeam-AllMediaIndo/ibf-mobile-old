                    ...
                    <form method="POST">
                        <div class="form-group boxed">
                            ...
                            <!-- <div class="input-wrapper mt-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo $user1['MBR_PEKERJAAN'] ?>" placeholder="Isi sesuai dengan KTP" name="pekerjaan" required autocomplete="off">
                            </div>
                            <div class="input-wrapper mt-3">
                                <label class="label">Jenis Kelamin</label>
                                <select class="form-control custom-select" id="sts_kawin" name="jenis_klemain" required>
                                    <option disabled selected value>Jenis Kelamin Anda</option>
                                    <option <?php //if($user1['MBR_STS_PRKWN'] == 'Laki-laki'){ echo 'selected'; } ?> value="Laki-laki">Laki-laki</option>
                                    <option <?php //if($user1['MBR_STS_PRKWN'] == 'Perempuan'){ echo 'selected'; } ?> value="Perempuan">Perempuan</option>
                                </select>
                            </div>
                            <div class="input-wrapper mt-3">
                                <label class="label">Status</label>
                                <select class="form-control custom-select" id="sts_kawin" name="sts_kawin" required>
                                    <option disabled selected value>Status perkawinan anda</option>
                                    <option <?php //if($user1['MBR_STS_PRKWN'] == 'Menikah'){ echo 'selected'; } ?> value="Menikah">Menikah</option>
                                    <option <?php //if($user1['MBR_STS_PRKWN'] == 'Cerai Hidup'){ echo 'selected'; } ?> value="Cerai Hidup">Cerai Hidup</option>
                                    <option <?php //if($user1['MBR_STS_PRKWN'] == 'Cerai Mati'){ echo 'selected'; } ?> value="Cerai Mati">Cerai Mati</option>
                                </select>
                            </div>
                            <div class="input-wrapper mt-3">
                                <label class="label">Profil Resiko</label>
                            </div>
                            <div class="row">
                                <div class="col-4">    
                                    <div class="input-wrapper mt-3">
                                        <input class="form-check-input" type="radio" name="profil_resk" value="CCD SEDERHANA" id="radio1" required>
                                        <label class="label" style="font-size: 12px;">CCD SEDERHANA</label>
                                    </div>
                                </div>
                                <div class="col-4">    
                                    <div class="input-wrapper mt-3">
                                        <input class="form-check-input" type="radio" name="profil_resk" value="EDD" id="radio1" required>
                                        <label class="label">EDD</label>
                                    </div>
                                </div>
                                <div class="col-4">    
                                    <div class="input-wrapper mt-3">
                                        <input class="form-check-input" type="radio" name="profil_resk" value="NDD" id="radio1" required>
                                        <label class="label">NDD</label>
                                    </div>
                                </div>
                            </div>
                            <div class="input-wrapper mt-3">
                                <label class="label">Nama MWPP</label>
                                <input type="text" class="form-control" value="<?php //echo $user1['MBR_NAMA_MWPP'] ?>" placeholder="Masukan Nama MWPP" name="mwpp" required autocomplete="off">
                            </div> -->
                            <div class="col mt-3">
