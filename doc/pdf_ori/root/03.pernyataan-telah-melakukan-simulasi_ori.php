...
<?php
    ...
    $content = '
        ...
        <html>
            ...
            <body>
                ...
                <table style="width:100%">
                    <tr>
                        <td width="50%" style="vertical-align: top; "><strong><small>Formulir Nomor : 107.PBK.02.1</small></strong></td>
                ...
                <div style="text-align:center;vertical-align: middle;padding: 10px 0 10px 0;">
                    <h3>PERNYATAAN TELAH MELAKUKAN SIMULASI PERDAGANGAN BERJANGKA KOMODITI</h3>
                </div>
                ...
                <div style="margin-top:25px;">
                    ...
                    bertransaksi di bidang Perdagangan Berjangka Komoditi pada PT.International Business Futures, dan telah
                ...
                <div style="text-align:center;margin-top:25px;margin-left:25%">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top;"><div style="margin:0px 5px;">:</div></td>
                            <td><strong>'.date('Y-m-d H:i:s', strtotime($ACC_F_SIMULASI_DATE)).'</strong></td>
                        </tr>
                        <tr>
                            <td>IP Address</td>
                            <td style="vertical-align: top;"><div style="margin:0px 5px;">:</div></td>
    ...
    $dompdf->render();
    $dompdf->stream("PT.International Business Futures - 107.PBK.02.01",array("Attachment"=>0));
