                ...
                ?>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="align-self-center ms-auto">
                            ...
                            <span class="slider-next badge bg-<?php if($HIST_RES["DPWD_STS"] == 'Pending'){ echo 'yellow';}elseif($HIST_RES["DPWD_STS"] == 'Accept'){ echo 'green';}else{echo 'red';}?>-dark mt-2 p-2 font-8"><?php echo $HIST_RES["DPWD_STS"]?></span>
                        </div>
                    </div>   
                <?php }; } else { ?>
