        ...
        if(isset($_POST['id_live'])){
            if(isset($_POST['aggree'])){
                ...
                if($aggree == 'Yes'){
                    mysqli_query($db, '
                        UPDATE tb_racc SET
                        tb_racc.ACC_F_SIMULASI = 1,
                        tb_racc.ACC_F_SIMULASI_PERYT = "'.$aggree.'",
                        tb_racc.ACC_F_SIMULASI_IP = "'.$IP_ADDRESS.'",
                        tb_racc.ACC_F_SIMULASI_DATE = "'.date('Y-m-d H:i:s').'"
...
?>
                    ...
                    <strong>Terima Pernyataan untuk melanjutkan</strong>
                    <button type="button" class="close color-white opacity-60 font-16" data-bs-dismiss="alert" aria-label="Close">&times;</button>
                    </div>
<?php
                }
            } else {
                logerr("Parameter Ke-3 Tidak Lengkap", "Simulasi Perdagangan", $user1["MBR_ID"]);
                die ("<script>location.href = 'home.php?page=live_019&id=".$id_live."'</script>"); 
            }
        } else {
            logerr("Parameter Ke-2 Tidak Lengkap", "Simulasi Perdagangan", $user1["MBR_ID"]);
            die ("<script>location.href = 'home.php?page=live_019&id=".$id_live."'</script>"); 
        }
    } else {
        logerr("Parameter Ke-1 Tidak Lengkap", "Simulasi Perdagangan", $user1["MBR_ID"]);
        die ("<script>location.href = 'home.php?page=live_019&id=".$id_live."'</script>"); 
    }
};
?>
...
<form method="post">
        ...
        <div class="card-body">
            <div class="row">
                <!-- <div class="col-6 text-left">
                    <strong><small><b>Formulir Nomor 107.PBK.02.1</b></small></strong>
                </div> -->
            ...
            <h6 class="text-center">FORMULIR PERNYATAAN TELAH MELAKUKAN SIMULASI PERDAGANGAN BERJANGKA KOMODITI</h5>
            <hr>
            <table class="table1">
                <tr>
                    <td>Nama Lengkap</td>
            ...
            <p>
                ...
                Berjangka Komoditi pada <strong><?php echo $web_name_full ?></strong>, 
                dan telah memahami tentang tata cara bertransaksi di bidang Perdagangan 
                Berjangka Komoditi.<br>
                Demikian Pernyataan ini dibuat dengan sebenarnya dalam keadaan sadar, sehat jasmani dan rohani serta tanpa paksaan apapum dari pihak manapun
            </p>
    ...
    <div class="card card-style">
        ...
        <button class="btn btn-full btn-primary rounded-sm shadow-xl font-800 btn-m" type="submit" name="submit_019">Next</button>
    </div>
</form>