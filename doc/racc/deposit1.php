                ...
                if(isset($_FILES["dps_proof"]) && $_FILES["dps_proof"]["error"] == 0){
                    ...
                    if(array_key_exists($s5_6_doc1_ext, $allowed)){
                        if(in_array($s5_6_doc1_type, $allowed)){
                            ...
                            } else { die("<script>alert('please try again or contact support3');location.href = 'home.php?page=account'</script>"); };
                        } else { die("<script>alert('please try again or contact support4');location.href = 'home.php?page=account'</script>"); };
                    } else { die("<script>alert('please try again, select other picture');location.href = 'home.php?page=account'</script>"); };
                } else { die("<script>alert('please try again or contact support6');location.href = 'home.php?page=account'</script>"); };
            } else { die("<script>location.href = 'home.php?page=dashboard&notif=".base64_encode('perhatikan nilai deposit')."'</script>"); };
        } else { die("<script>alert('please try again or contact support7');location.href = 'home.php?page=account'</script>"); };
    };
