        ...
        if(isset($_POST['aggree'])){
            if(isset($_GET['id'])){
                ...
                if($aggree == 'Yes'){
                    ...
                    die ("<script>location.href = 'home.php?page=racc/disclosure4&id=".$id_live."'</script>");
                }else{ die("<script>location.href = 'home.php?page=racc/dokumentadanyaresiko&id=".$id_live."'</script>");};
            } else {
                logerr("Parameter Ke-2 Tidak Lengkap", "Dokumen Adanya Resiko", $user1["MBR_ID"]);
                die ("<script>location.href = 'home.php?page=racc/dokumentadanyaresiko&id=".$id_live."'</script>"); 
            };
        } else {
            logerr("Parameter Ke-1 Tidak Lengkap", "Dokumen Adanya Resiko", $user1["MBR_ID"]);
            die ("<script>location.href = 'home.php?page=racc/dokumentadanyaresiko&id=".$id_live."'</script>"); 
        };
    };
?>
                    ...
                    <div class="mt-3">
                        ...
                        <ol>
                            ...
                            <li class="text-justify mt-2">
                                ...
                                Kontrak <?php echo ucwords($title); ?>, Anda dapat 
                                ...
                                Apabila pergerakan di pasar terhadap Kontrak <?php echo ucwords($title); ?> 
                                menurunkan nilai posisi Anda dalam Kontrak 
                                <?php echo ucwords($title); ?>, <i>dengan kata lain 
                            ...
                            <li class="text-justify mt-2">
                                ...
                                Kontrak <?php echo ucwords($title); ?>. Apabila Anda 
                                tidak dapat melikuidasi posisi Kontrak <?php echo ucwords($title); ?>, 
                                ...
                                lazim pada Kontrak <?php echo $shrt_title ?> atau subjek Kontrak <?php echo $shrt_title ?>, atau 
                            ...
                            <li class="text-justify mt-2">
                                ...
                                Anda dapat menderita kerugian jika amanat untuk melaksanakan transaksi Kontrak <?php echo ucwords($title); ?> tidak dapat dilakukan 
