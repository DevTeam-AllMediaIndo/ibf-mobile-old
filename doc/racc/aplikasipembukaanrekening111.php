                            ...
                            if($s5_6_doc1_size < 5000000) {
                                if(array_key_exists($s5_6_doc1_ext, $allowed)){
                                    if(in_array($s5_6_doc1_type, $allowed)){
                                        ...
                                        } else { die ("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('File is not uploaded.')."'</script>"); }
                                    } else { die ("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('Error: There was a problem uploading your file. Please try again.')."'</script>"); }
                                } else { die ("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('Only *.jpg, *.jpeg, *.png')."'</script>"); }
                            } else { die ("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('Maximum 5 MB.')."'</script>"); }
                        };
                        ...
                        if($s5_6_doc1_sts == -1){
                            if($s5_6_fotoself_sts == -1){
                                if($s5_6_fotoid_sts == -1){
                                    ...
                                    ') or die (mysqli_error($db));
                                    die ("<script>location.href = 'home.php?page=racc/disclosure2&id=".$id_live."'</script>");
                                } else { die("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('pastikan untuk mengupload KTP/Passport.')."'</script>"); }
                            } else { die("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('pastikan untuk mengupload Foto Terbaru.')."'</script>"); }
                        } else { die("<script>location.href = 'home.php?page=racc/aplikasipembukaanrekening11&id=".$id_live."&notif=".base64_encode('pastikan untuk mengupload Dokument Pendukung.')."'</script>"); }
                    };
