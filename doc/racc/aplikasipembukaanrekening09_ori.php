            ...
            if(isset($_POST['njop'])){
                if(isset($_POST['dpstbk'])){
                    if(isset($_POST['jumlah'])){
                        ...
                        }else { die ("<script>alert('Please try again1');location.href = ''</script>");}
                    }else { die ("<script>alert('Please try again1');location.href = ''</script>");}
                }else { die ("<script>alert('Please try again1');location.href = ''</script>");}
            }else { die ("<script>alert('Please try again1');location.href = ''</script>");}
        }else { die ("<script>alert('Please try again1');location.href = ''</script>");}
        ...
        <div class="card-body">
            ...
            <div class="form-group boxed">
                ...
                <div class="input-wrapper mt-3">
                    ...
                    <input type="number" class="form-control" id="text4b" placeholder="Masukkan NJOP nilai anda" name="njop" 
                        value="<?php
                ...
                <div class="input-wrapper mt-3">
                    ...
                    <input type="number" class="form-control" id="text4b" placeholder="Silahkan isi '0' jika tidak memiliki" name="dpstbk" 
                        value="<?php
                ...
                <div class="input-wrapper mt-3">
                    ...
                    <input type="number" class="form-control" id="text4b" placeholder="Silahkan isi '0' jika tidak memiliki" name="jumlah" 
                        value="<?php
