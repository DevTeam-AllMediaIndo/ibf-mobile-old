    ...
    if(isset($_POST['submit_08'])){
        if(isset($_POST['step07_kotapenyelesaian'])){
            if(isset($_POST['step07_kantorpenyelesaian'])){
                ...
                } else { die ("<script>alert('please try again2');location.href = 'home.php?page=racc/perjanjianamanat&id=".$id_live."'</>"); }
            } else { die ("<script>alert('please try again1');location.href = 'home.php?page=racc/perjanjianamanat&id=".$id_live."'</script>"); }
        } else { die ("<script>alert('please try again1');location.href = 'home.php?page=racc/perjanjianamanat&id=".$id_live."'</script>"); }
    };
        ...
        <div class="card-body">
            <div class="form-group boxed">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <p class="text-justify">Pada hari ini <?php echo $date_day ?>, tanggal <?php echo date('d') ?>, bulan <?php echo $date_month ?>, <?php echo date('Y') ?>, kami
                        ...
                        transaksi penjualan maupun pembelian Kontrak <?php echo $title; ?> dengan ketentuan sebagai berikut:</p>
                        <ol>
                            ...
                            <li seq="<?php if($ACC_TYPE1 == 1){ echo '2'; } else { echo '2'; } ?>.">
                                ...
                                <?php } else if($ACC_TYPE1 == 2){ ?>
                                    <ol>
                                        ...
                                        Alternatif PT. Real Time Forex Indonesia yang telah memiliki Perjanjian Kerjasama dengan Pialang Berjangka
                                        </li>
                            ...
                            <li seq="<?php if($ACC_TYPE1 == 1){ echo '24'; } else { echo '22'; } ?>.">
                                ...
                                <ol>
                                    ...
                                    <li seq=" (<?php if($ACC_TYPE1 == 1){ echo '4'; } else { echo '8'; } ?>)">Kantor atau kantor cabang Pialang Berjangka terdekat dengan domisili Nasabah tempat penyelesaian dalam hal terjadi perselisihan.
                                        <table width="50%" style="margin-left:5px;">
                                            ...
                                            <tr>
                                                <td style="vertical-align:top"><input type="radio" class="form-check-input radio_css" checked="checked" name="step07_kantorpenyelesaian" value="BANDUNG" required ></td>
                            ...
                            <li seq="<?php if($ACC_TYPE1 == 1){ echo '25'; } else { echo '23'; } ?>.">
                        ...
                        <div class="text-left"><label style="cursor:pointer;"><input type="checkbox" class="form-check-input" style="border: 1.5px solid black !important;" id="cb_25" onclick="run1();" value="YA" required/> Saya telah membaca dan menyetujui dari semua isi perjanjian ini</label></div>
                    </div>
                </div>
                <p>
...
<script>
    ...
    function run1(){
        if(document.getElementById("cb_25").checked == true){ 
