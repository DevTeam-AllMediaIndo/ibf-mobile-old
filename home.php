...
<!-- Load font dengan format optimal -->
...
<script>
    const firebaseConfig = {
        apiKey: "AIzaSyDAGr-hY3P1zMVvBfwc2CaNOPO7mZSOisQ",
        authDomain: "ibfmobile-4e0fd.firebaseapp.com",
        databaseURL: "https://ibfmobile-4e0fd-default-rtdb.asia-southeast1.firebasedatabase.app",
        projectId: "ibfmobile-4e0fd",
        storageBucket: "ibfmobile-4e0fd.appspot.com",
        messagingSenderId: "1020351356597",
        appId: "1:1020351356597:web:cfb94133ff228c4a94a8fc"
    };
    ...
    <div id="footer-bar" class="footer-bar-5">
        ...
        <a href="home.php?page=account" 
            <?php 
                ...
                $login_page == 'racc/disclosure1'||
                $login_page == 'racc/disclosure2'||
                $login_page == 'racc/disclosure3'||
                $login_page == 'racc/disclosure4'||
